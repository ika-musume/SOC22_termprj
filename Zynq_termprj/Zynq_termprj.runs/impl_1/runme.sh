...
HD_PWD='C:/Users/kiki1/Desktop/assignments/Zynq_termprj/Zynq_termprj.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log termprj_top_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source termprj_top_wrapper.tcl -notrace
