...
HD_PWD='C:/Users/kiki1/Desktop/assignments/Zynq_termprj/Zynq_termprj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log termprj_top_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source termprj_top_wrapper.tcl
