...
HD_PWD='C:/Users/kiki1/Desktop/assignments/Zynq_termprj/Zynq_termprj.runs/termprj_top_rotaryio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log termprj_top_rotaryio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source termprj_top_rotaryio_0_0.tcl
