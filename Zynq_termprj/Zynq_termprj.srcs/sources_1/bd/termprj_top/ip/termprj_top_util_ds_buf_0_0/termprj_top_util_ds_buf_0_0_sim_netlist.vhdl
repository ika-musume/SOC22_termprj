...
-- Command     : write_vhdl -force -mode funcsim -rename_top termprj_top_util_ds_buf_0_0 -prefix
--               termprj_top_util_ds_buf_0_0_ termprj_top_util_ds_buf_0_0_sim_netlist.vhdl
...
entity termprj_top_util_ds_buf_0_0_util_ds_buf is
  port (
  ...
  attribute C_BUFGCE_DIV of termprj_top_util_ds_buf_0_0_util_ds_buf : entity is 1;
  attribute C_BUF_TYPE : string;
  attribute C_BUF_TYPE of termprj_top_util_ds_buf_0_0_util_ds_buf : entity is "BUFG";
  attribute C_SIZE : integer;
  attribute C_SIZE of termprj_top_util_ds_buf_0_0_util_ds_buf : entity is 1;
end termprj_top_util_ds_buf_0_0_util_ds_buf;

architecture STRUCTURE of termprj_top_util_ds_buf_0_0_util_ds_buf is
...
entity termprj_top_util_ds_buf_0_0 is
  ...
  attribute NotValidForBitStream of termprj_top_util_ds_buf_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of termprj_top_util_ds_buf_0_0 : entity is "termprj_top_util_ds_buf_0_0,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of termprj_top_util_ds_buf_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of termprj_top_util_ds_buf_0_0 : entity is "util_ds_buf,Vivado 2019.1";
end termprj_top_util_ds_buf_0_0;

architecture STRUCTURE of termprj_top_util_ds_buf_0_0 is
  ...
  attribute x_interface_parameter of BUFG_I : signal is "XIL_INTERFACENAME BUFG_I, FREQ_HZ 52631580, PHASE 0.000, CLK_DOMAIN termprj_top_processing_system7_0_1_FCLK_CLK0, INSERT_VIP 0";
  attribute x_interface_info of BUFG_O : signal is "xilinx.com:signal:clock:1.0 BUFG_O CLK";
  attribute x_interface_parameter of BUFG_O : signal is "XIL_INTERFACENAME BUFG_O, FREQ_HZ 52631580, PHASE 0.000, CLK_DOMAIN termprj_top_processing_system7_0_1_FCLK_CLK0, INSERT_VIP 0";
begin
U0: entity work.termprj_top_util_ds_buf_0_0_util_ds_buf
     port map (
      BUFGCE_CE(0) => '0',
      BUFGCE_CLR(0) => '0',
      BUFGCE_I(0) => '0',
